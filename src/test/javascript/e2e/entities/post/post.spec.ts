...
describe('Post e2e test', () => {
  ...
  it('should load Posts', async () => {
    ...
    expect(await postComponentsPage.getTitle()).to.eq('riverApp.post.home.title');
  });

  it('should load create Post page', async () => {
    await postComponentsPage.clickOnCreateButton();
    postUpdatePage = new PostUpdatePage();
    expect(await postUpdatePage.getPageTitle()).to.eq('riverApp.post.home.createOrEditLabel');
  ...
  it('should create and save Posts', async () => {
    ...
    await promise.all([
      ...
      postUpdatePage.projetSelectLastOption()
  ...
  it('should delete last Post', async () => {
    ...
    expect(await postDeleteDialog.getDialogTitle()).to.eq('riverApp.post.delete.question');
