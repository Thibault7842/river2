...
import fr.inti.river.config.audit.AuditEventConverter;
import fr.inti.river.domain.PersistentAuditEvent;
...
import static fr.inti.river.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
